...
//     expect(controller.selectedLevel.value?.id, AppConfig.defaultLevel.id);
//     expect(controller.isLevelUnlocked(AppConfig.defaultLevel.id), isTrue);
//   });
...
//     expect(controller.isLevelCompleted(AppConfig.defaultLevel.id), isTrue);
